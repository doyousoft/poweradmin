...
CREATE TABLE `perm_templ_items` (
  ...
  KEY `perm_id` (`perm_id`), 
  CONSTRAINT `perm_templ_items_ibfk_1` FOREIGN KEY (`templ_id`) REFERENCES `perm_templ` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `perm_templ_items_ibfk_2` FOREIGN KEY (`perm_id`) REFERENCES `perm_items` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `users` (
  ...
  `perm_templ` int(11) DEFAULT NULL,
  `active` tinyint(1) NOT NULL default '0',
  PRIMARY KEY  (`id`),
  KEY perm_templ(perm_templ),
  CONSTRAINT `users_ibfk_1` FOREIGN KEY (`perm_templ`) REFERENCES `perm_templ` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE zone_templ (
  ...
  PRIMARY KEY (id),
  KEY `owner` (`owner`),
  CONSTRAINT `zone_templ_ibfk_1` FOREIGN KEY (`owner`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE zone_templ_records (
  ...
  CONSTRAINT `zone_templ_records_ibfk_1` FOREIGN KEY (`zone_templ_id`) REFERENCES `zone_templ` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `zones` (
  ...
  PRIMARY KEY  (`id`),
  KEY `owner` (`owner`),
  CONSTRAINT `zones_ibfk_1` FOREIGN KEY (`zone_templ_id`) REFERENCES `zone_templ` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `zones_ibfk_2` FOREIGN KEY (`domain_id`) REFERENCES `domains` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `zones_ibfk_3` FOREIGN KEY (`owner`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
